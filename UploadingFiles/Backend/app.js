...
var imageRouter = require('./routes/imageController');
var videoRouter = require('./routes/vedioController')
...
app.use('/uploads/documents',documentRouter);
app.use('/uploads/images',imageRouter);
app.use('/uploads/videos',videoRouter);
