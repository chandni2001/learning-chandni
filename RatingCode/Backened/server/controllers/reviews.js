...
module.exports = {
  ...
  async findReviewById(ctx) {
    ...
    try {
      ...
      // Sanitize the review data for the response
      const sanitizedReview = await sanitize.contentAPI.output(review, strapi.getModel('plugin::ratings.review'));

      ctx.body = {
        review: sanitizedReview
      };
    } catch (error) {
      ctx.throw(500, 'Error fetching the review');
    }
  }
}
